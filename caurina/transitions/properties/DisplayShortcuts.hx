...
class DisplayShortcuts {
	 ...
	 */
	public static function _frame_get (p_obj:Dynamic, p_parameters:Array<Dynamic>, ?p_extra:Dynamic = null) : Int {
#if flash8
	 ...
	 */
	public static function _frame_set (p_obj:Dynamic, p_value:Float, p_parameters:Array<Dynamic>, ?p_extra:Dynamic = null) : Void {
	 ...
	 */
	public static function _autoAlpha_get (p_obj:Dynamic, p_parameters:Array<Dynamic>, ?p_extra:Dynamic = null) : Float {
#if flash8
		return p_obj._alpha;
#elseif flash9
		return p_obj.alpha;
	 ...
	 */
	public static function _autoAlpha_set (p_obj:Dynamic, p_value:Float, p_parameters:Array<Dynamic>, ?p_extra:Dynamic = null) : Void {
#if flash8
	 ...
	 */
	public static function _scrollRect_property_get (p_obj:Dynamic, p_parameters:Array<Dynamic>, ?p_extra:Dynamic = null) : Float {
		return Reflect.field (p_obj.scrollRect, p_parameters[0]);
	}
	public static function _scrollRect_property_set (p_obj:Dynamic, p_value:Float, p_parameters:Array<Dynamic>, ?p_extra:Dynamic = null) : Void {

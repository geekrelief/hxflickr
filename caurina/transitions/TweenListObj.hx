...
class TweenListObj {
	...
	public var timeStart				:Float;		// Time when this tweening should start
	public var timeComplete				:Float;		// Time when this tweening should end
	...
	public var count					:Int;		// Number of times this caller should be called
	public var timesCalled				:Int;		// How many times the caller has already been called ("caller" tweens only)
	...
	public var skipUpdates				:Int;		// How many updates should be skipped (default = 0; 1 = update-skip-update-skip...)
	public var updatesSkipped			:Int;		// How many updates have already been skipped
